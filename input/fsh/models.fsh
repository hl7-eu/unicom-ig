...
//Inner package: Repeat Package 0..*
    * innerPackage 0..* class "Inner Package"
      * amount 1..1 class "Amount of inner packages inside the parent package e.g. number of blisters in the box, if this inner package is a blister"
        * value 1..1 QT "Value"
        * unit 0..1 CD "unit"
      * innerPackage 0..* contentReference https://build.fhir.org/ig/hl7-eu/unicom-ig/branches/jct-refs/FullMedicinalProduct#FullMedicinalProduct.packageProductDefinition.package.innerPackage  "Inner Package" // this is mutually exclusive to the manufacturedItem
//      * innerPackage 0..* contentReference #FullMedicinalProduct.packageProductDefinition.package.innerPackage  "Inner Package" // this is mutually exclusive to the manufacturedItem
