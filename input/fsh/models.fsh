...
* packagedProductDefinition 1..* class "Packaged product"
  ...
  * marketingAuthorisation 0..* contentReference https://hl7-eu.github.io/unicom-ig/branches/mpd-r5/StructureDefinition/FullMedicinalProduct#FullMedicinalProduct.marketingAuthorisation "MarketingAuthorisation"
  ...
  * package 1..1 class "Package"
    ...
    * innerPackage 0..* class "Inner Package"
      * containedItem 0..* class "The content of the inner package"
        ...
        * containedPackage 0..* contentReference https://hl7-eu.github.io/unicom-ig/branches/mpd-r5/StructureDefinition/FullMedicinalProduct#FullMedicinalProduct.packagedProductDefinition.package "Inner Packages"
