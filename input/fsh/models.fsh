  ...
  * package 1..1 class "Package"
    ...
    * innerPackage 0..* class "Inner Package"
      * containedItem 0..* class "The content of the inner package"
        ...
        * containedPackage 0..* contentReference http://hl7-eu.github.io/unicom-ig/StructureDefinition/FullMedicinalProduct#FullMedicinalProduct.packagedProductDefinition.package "Inner Packages"
