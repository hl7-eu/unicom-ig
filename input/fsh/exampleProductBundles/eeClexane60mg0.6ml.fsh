Instance: 010-Clexane-60mg-06ml-EE-FullProduct
InstanceOf: Bundle
Usage: #example
...
* subject = Reference(Clexane-60mg-06ml-solinj-EE-MPD)
...
Instance: Clexane-60mg-06ml-solinj-EE-APD
InstanceOf: PPLAdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(Clexane-60mg-06ml-solinj-EE-MPD)
...
* producedFrom = Reference(Clexane-60mg-06ml-solinj-EE-MID)
* routeOfAdministration.code = $100000073345#100000073633 "Subcutaneous use"

Instance: Clexane-60mg-06ml-solinj-EE-MID
...
Instance: Clexane-60mg-06ml-solinj-EE-I
InstanceOf: PPLIngredient
Usage: #inline
* status = #active
* for[0] = Reference(Clexane-60mg-06ml-solinj-EE-MPD)
* for[+] = Reference(Clexane-60mg-06ml-solinj-EE-MID)
* for[+] = Reference(Clexane-60mg-06ml-solinj-EE-APD)
...
* packageFor = Reference(Clexane-60mg-06ml-solinj-EE-MPD)
...
* package.package.containedItem.item.reference = Reference(Clexane-60mg-06ml-solinj-EE-MID)
