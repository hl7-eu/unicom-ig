...
* name.part[strength].part = "1500mg"
* name.part[doseForm].part = "süste-/infusioonilahuse pulber"
* name.usage.country = $100000000002#100000000388 "Republic of Estonia"
* name.usage.language = $100000072057#100000072172 "Estonian"
...
//* packaging.packaging.containedItem.item.reference = Reference(Cefuroxime-MIP-1500mg-Pdr-solinj-inf-EE-MID)
